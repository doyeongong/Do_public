...
@time begin
    ...
    @showprogress for t=T:-1:T  # Backward!
            ...
            for z_idx=1:1
                ...
                for h_idx=1:1
                    ...
                    for a_idx=55:55
                        ...
                        println("a=$(a), a_idx=$(a_idx), h=$(h), z=$(z), t=$(t)")
                        ####### (Renter) ##############
                        ...
                        # println("a=$(a), h=$(h), z=$(z), t=$(t), V=$(V[a_idx, h_idx, z_idx, t])")
                    end
                end
            end
...
elseif run==3
    market_error(0.130264346011243, 1.78135986422181; print_on=0)
end
